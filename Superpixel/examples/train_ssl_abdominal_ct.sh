...
do
    ...
    echo $PREFIX
    LOGDIR="/content/gdrive/MyDrive/One-Shot/Few-Shot-Medical-Segmentation/exps/${CPT}_${SUPERPIX_SCALE}_${LABEL_SETS}"
    ...
    python /content/gdrive/MyDrive/One-Shot/Few-Shot-Medical-Segmentation/training.py with \
